...
<body>
	...
	<div class="content" id="content">
	    <div class="row column text-center">
	      ...
	      <hr>
	      <div class="container">
	      	<form action="${path1 }/board/boardInsert" method="post">
			      <table id="table1">
			      	<tbody>
			      		<tr>
			      		...
			      		<th style="background-color:#dcdcdc">작성자</th>
			      			<td>
			      				<input type="text" name="nickname" id="nickname" placeholder="작성자 입력" maxlength="98" required>
			      			</td>
						</tr>
			      		<tr>
			      			<td colspan="2">
			      				<input type="submit" class="submit success button" value="글 등록" >
			      				<a class="button" href="${path1 }/board/boardList">글 목록</a>
			      			</td>
			      		</tr>
			      	</tbody>
			      </table>
